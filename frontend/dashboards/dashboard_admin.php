...
<head>
    ...
    <link rel="stylesheet" href="dash_mod_2.css">
...
<body>
    ...
    <script>
        ...
        function showUpdateUser(){
            ...
            "<label><input type='submit' value='Create driver'></label><br>" ;
            content_area.innerHTML = "<form name='add_user' action='../admin_ops/updateUser.php' method='post'><h3>Update User Details</h3>" + add_content +"</form>";
        }
        ...
        function showDeleteUser(){
            ...
            content_area.innerHTML = "<form name='add_user' action='../admin_ops/deleteUser.php' method='post'><h3>Update User Details</h3>" + delete_content +"</form>";
        }
