...
<head>
    ...
    <link rel="stylesheet" href="../css/dash_driver.css">
...
<body>
    ...
    <div class="main-content"> 
        <form  action="../phpfiles/functions/logout.php" method="post" id="main-c-form">
        <div id="hr-dash-nav">
...
xhttp2.open('GET', '../phpfiles/functions/fetch_report.php', true);
xhttp2.send();
...
xhttp3.open("GET", "../phpfiles/functions/fetch_stat.php", true);
xhttp3.send()
...
// search driver
    ...
    search_div.innerHTML = "<form action='../phpfiles/functions/searchDriver.php' method='post'>" + search_content + "</form> <div id='search_res'> </div>"
        ...
        document.getElementById('sub-btn').addEventListener('click',()=>{
            ...
            let data = {f_name: f_name, l_name: l_name}
                xhr.open("POST", "../phpfiles/functions/searchDriver.php", false);
