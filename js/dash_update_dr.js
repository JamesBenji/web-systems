...
function set_status_ongoing() {
  ...
  xhttp.open("GET", "../phpfiles/set_status/set_ongoing.php", true);
  xhttp.send();
}
...
function load_cur_del() {
    ...
    if (this.readyState == 4 && this.status == 200) {
      ...
      while (i < json_ret_len) {
        ...
        finishbtn.addEventListener('click', function(e) {
          ...
          xhr.open("POST", "../phpfiles/set_status/set_completed.php", true);
          ...
          // to automatically refresh aand show changes to user
          setTimeout(function (){
  ...
  xhttp.open("GET", "../phpfiles/textscripts/curDel.php", true);
  xhttp.send();
}
...
function load_rec_del() {
  ...
  xhttp.open("GET", "../phpfiles/textscripts/recDel.php", true); // Corrected the file path
  xhttp.send();
}
...
function load_up_del() {
  ...
  xhttp.open("GET", "../phpfiles/textscripts/upDel.php", true);
  xhttp.send();
}
